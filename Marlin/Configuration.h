...
#define STRING_CONFIG_H_AUTHOR "(Schleir, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Nivya's"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -11, -2.5 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
// To allow BlTouch to go a little bit more to the edges.
